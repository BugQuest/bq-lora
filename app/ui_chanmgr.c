...
void ui_chanmgr_open_e(lv_event_t *e) {
    ...
    /* Rappel du couplage (Option A) : ces canaux appartiennent a la preconfig
     * radio courante. Appliquer une preconfig depuis Radio les remplace tous.
     * Pour les garder, capture-les dans la preconfig (Radio > Capturer canaux). */
    label(cm_ov,
          "Lies a la preconfig radio courante. Pour les rendre permanents :\n"
          "Radio > Capturer canaux actuels > Save.",
          FONT_SMALL, CY_DIM);
